...
/// </summary>
    ...
    /// </summary>
        void InitializeComponent(void){
            ...
            this->lbl_message->TabIndex = 16;this->lbl_message->Text = L"Message";
            // 
            // txt_message
            // 
    ...
    #pragma endregion
        ...
        private: System::Void button1_Click(System::Object ^ sender, System::EventArgs ^ e) {
            ...
            this->dgv_adresses->DataSource = this->dsPersonneAdresses; this->dgv_adresses->DataMember = "AdressesPersonnes"; 
            this->dgv_adresses->Columns["id_personne"]->Visible = false; this->dgv_adresses->Columns["id_adresse"]->Visible = false; 
        ...
        private: System::Void btn_enr_Click(System::Object^ sender, System::EventArgs^ e) {
            if (this->mode == "nouveau") {
                int i; int ii; int taille = (this->dgv_adresses->RowCount - 1) * 3; array<String^>^ lesAdresses = gcnew array<String^>(taille); ii = 0; for (i = 0; i < taille - 1; i++) { lesAdresses[i] = Convert::ToString(this->dgv_adresses[0, ii]->Value); i++; lesAdresses[i] = Convert::ToString(this->dgv_adresses[1, ii]->Value); i++; lesAdresses[i] = Convert::ToString(this->dgv_adresses[2, ii]->Value); ii++; }
        ...
        private: System::Void btn_sup_Click(System::Object^ sender, System::EventArgs^ e) { 
            ...
            this->txt_prenom->Text = ""; 
            this->dgv_adresses->DataSource = nullptr; 
            this->txt_message->Text = "L'enregistrement a étésupprimer."; 
        }
        ...
        private: void initialisationENR(void) { 
            ...
            this->index = 0; this->txt_id->Text = Convert::ToString(this->dsPersonne->Tables["LesClients"]->Rows[0]->ItemArray[0]); 
